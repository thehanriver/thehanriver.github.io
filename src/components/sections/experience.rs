        ...
        <Section id="experience" title="Experience">
            <Job
                ...
                description_points={vec![
                    ...
                    "Current Tech Stack: JS/HTML/CSS and Node, Rust, GraphQL, NoSQL, PostGresSQL".to_string(),
                ]}
            />
            <Job
            ...
            />
            // --- Add the rest of your jobs here using the <Job /> component ---
            // <Job title="Software Engineering Intern" company="Wildseed Tech" ... />
